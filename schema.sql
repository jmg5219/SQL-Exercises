...
SELECT restaurants.name,review,reviewer.name FROM reviews INNER JOIN reviewer on reviews.reviewer_id = reviewer.id INNER JOIN restaurants on reviews.restaurant_id = restaurants.id ;
